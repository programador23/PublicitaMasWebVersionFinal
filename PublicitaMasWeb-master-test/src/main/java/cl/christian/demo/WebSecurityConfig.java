...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests().antMatchers("/index","/listarPublicidad", "/listacarteles", "/detalle/**" ,"detallecartel/**", "/nombre/detalle/**","/listacarteles","/detallecartel/**","/recursos/**","/registro").permitAll()
...
//		//.antMatchers("/listacartelesusuario").hasRole("USER")
